...
struct CategoryView: View {
    ...
    @Binding var categories: [String] // リストに表示するカテゴリの配列
    @Binding var selectedCategory: String?       // 親画面から渡される選択されたカテゴリ
...
#Preview {
    ...
    @Previewable @State var selectedCategory: String? = "ドレス"
    @Previewable @State var categories: [String] = ["披露宴","挙式"]
